  ...
  if (rightOriented) {
    return (
        <div className="w-full flex flex-row">
          ...
          <div className="flex items-center justify-center p-20 pr-0 bg-amber-600 relative">
            <div className="project-image bg-popover-foreground text-background flex items-center justify-center flex-col rounded-xl shadow-black shadow-xl">
    ...
    return (
        <div className="w-full flex flex-row">
          <div className="flex items-center justify-center p-20 pl-0 bg-amber-600 relative">
            <div className="project-image bg-popover-foreground text-background flex items-center justify-center flex-col rounded-xl shadow-black shadow-xl">
              <div className="flex flex-auto w-[500px]">
                  <img src={image} className="h-full w-full"></img>
              </div> 
